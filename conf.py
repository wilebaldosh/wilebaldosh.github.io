...
BLOG_AUTHOR = "Wilebaldo Santana"  # (translatable)
BLOG_TITLE = "Blog personal de Wilebaldo Santana"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://wilebaldosh.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://wilebaldosh.github.io/"
BLOG_EMAIL = "wisahe@gmail.com"
BLOG_DESCRIPTION = "Vida, ciencias, artes y demás."  # (translatable)
